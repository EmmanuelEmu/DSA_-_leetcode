...
int solve(int ind, int buy, vector<int>& prices, vector<vector<vector<int>>>& dp, int trans) {
...
int maxProfit(vector<int>& prices) {
    ...
    return solve(0, 1, prices, dp, 0);  // Start at index 0, buy allowed, 0 transactions completed
}
